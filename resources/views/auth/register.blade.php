    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="border-radius: 10px">
                <div class="card-header bg-primary text-white" style="border-radius: 10px">{{ __('Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            @php
                                $roles = DB::table('roles')->select(DB::raw('role_name, id_role'))->get();
                            @endphp
                            <div class="col-md-6">
                                <select class="form-select form-select-lg mb-3" style="font-size: 100%" name="role" id="role">
